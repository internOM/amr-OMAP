...
#include "om_msgs/msg/detail/response__rosidl_typesupport_fastrtps_c.h"
...
using _Response__ros_msg_type = om_msgs__msg__Response;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
bool cdr_serialize_om_msgs__msg__Response(
  const om_msgs__msg__Response * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
bool cdr_deserialize_om_msgs__msg__Response(
  eprosima::fastcdr::Cdr & cdr,
  om_msgs__msg__Response * ros_message)
{
  // Field name: data
  {
    size_t size = 64;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
size_t get_serialized_size_om_msgs__msg__Response(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
size_t max_serialized_size_om_msgs__msg__Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = om_msgs__msg__Response;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
bool cdr_serialize_key_om_msgs__msg__Response(
  const om_msgs__msg__Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
size_t get_serialized_size_key_om_msgs__msg__Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Response__ros_msg_type * ros_message = static_cast<const _Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_om_msgs
size_t max_serialized_size_key_om_msgs__msg__Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const om_msgs__msg__Response * ros_message = static_cast<const om_msgs__msg__Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_om_msgs__msg__Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  om_msgs__msg__Response * ros_message = static_cast<om_msgs__msg__Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_om_msgs__msg__Response(cdr, ros_message);
}

static uint32_t _Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_om_msgs__msg__Response(
...
static size_t _Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_om_msgs__msg__Response(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, om_msgs, msg, Response)() {
